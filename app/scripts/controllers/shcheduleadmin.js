...
/**
 * @ngdoc function
 * @name kenwoodApp.controller:ShcheduleadminCtrl
 * @description
 * # ShcheduleadminCtrl
 * Controller of the kenwoodApp
 */
angular.module('kenwoodApp')
  .controller('ShcheduleadminCtrl', function ($scope, $sce, fbutil, $timeout) {
  $scope.items = fbutil.syncArray('events', {limit: 12});
